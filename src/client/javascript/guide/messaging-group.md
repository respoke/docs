...
Sending messages to a group of people is easy and secure with Respoke. First, [join a group](/client/javascript/guide/group-joining.html) and then we're ready to start writing some code.
